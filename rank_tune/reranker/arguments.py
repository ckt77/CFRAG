...
class ModelArguments:
    ...
    teacher_temperature: float = field(default=0.1)
...
class DataArguments:
    train_data: str = field(
        default=
        "../../Qwen2-7B-Instruct_outputs/LaMP_2_time/train/recency/bge-base-en-v1.5_5/retrieval/point_20251208-152626_user-6_20251208-134246_vllm_new-64/predictions_0-100.json",
    ...
    max_len: int = field(
        ...
        metadata={
            "help":
            "The maximum total input sequence length after tokenization for input text. Sequences longer "
